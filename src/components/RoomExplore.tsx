    ...
    return (
        <Container style=" bg-[url('/subtle-stripes.png')] py-8 ">
            <div className="flex flex-col lg:flex-row lg:gap-x-12">
                ...
                <div data-aos="fade-down-right" className="relative h-[200px] sm:h-[400px] w-full overflow-hidden rounded-md lg:mb-0 lg:h-auto lg:w-[40%]">
                    <Image
                ...
                <div className="flex flex-col justify-between lg:w-[60%] space-y-6 py-3">
