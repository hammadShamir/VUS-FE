...
const BookingForm = () => {
    ...
    return (
        <form
            ...
            className='flex flex-col relative bg-primary p-6 rounded-lg gap-y-6'
        >

            <div className='flex justify-between items-center text-background'>
                <h3 className='text-3xl font-[family-name:var(--font-primary)]'>Reserve:</h3>
                <h6 className='text-xl font-[family-name:var(--font-secondary)]'>From $299/night</h6>
            </div>
            ...
            <div className='flex justify-between items-center text-background'>
                <h3 className='text-3xl font-[family-name:var(--font-primary)]'>Total Cost</h3>
                <h6 className='text-xl font-[family-name:var(--font-secondary)]'>{formik.values.amount}$</h6>
            </div>
