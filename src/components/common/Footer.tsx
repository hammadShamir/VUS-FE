    ...
    <footer className="bg-primary bg-[url('/assets/img/bubble-bg.png')]">
      <Container style="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-6 py-6 md:py-12 text-background gap-6 lg:gap-12">
        ...
        <div data-aos="fade-left" className="lg:col-span-2 space-y-4">
          <Image
            ...
            className=""
          />
          <p className="text-base font-bold font-[family-name:var(--font-secondary)]">Welcome to Umah Shanti, where luxury meets serenity. Nestled in the heart of Bali, our villa offers a tranquil escape surrounded by nature&apos;s beauty and modern comfort. </p>
        </div>
        ...
        {/* Contacts */}
        <div className="md:col-span-2 space-y-4" data-aos="fade-left" data-aos-delay="800">
          ...
          <ul className="space-y-2 font-[family-name:var(--font-secondary)]">
            <li>
              <Link href={'https://maps.app.goo.gl/mVPNKym7BSmS2PP28'}> Jl. RSI Markandya 2, Gang Mawar,
                
                Banjar Sebali, Desa Keliki, Kecamatan
              
                Tegallalang - Bali, Indonesia</Link>
            </li>
            <li>
              <Link href={'mailto:umahshantivilla@gmail.com'}>E-mail: umahshantivilla@gmail.com</Link>
            </li>
            <li>
      ...
      <div className="border-t border-background py-4">
        <p className="text-sm md:text-base font-[family-name:var(--font-secondary)] text-center text-background">
          Copyright © {previousYear}-{currentYear} Umah Shanti. All Rights Reserved. Villa managed by Red Lotus.<p className="text-sm md:text-base font-[family-name:var(--font-secondary)] text-center text-background">
            Designed by <a href="mailto:developerhammad64@gmail.com" className="underline hover:text-secondary">Hammad Shamir</a>
          </p>
