...
const BookingsTable: React.FC<IBookingTable> = (props) => {
    ...
    const statusStyles: Record<string, string> = {
        [BookingStatus.pending]: "text-yellow-500 bg-yellow-100 dark:border-yellow-100",
        [BookingStatus.approved]: "text-green-500 bg-green-100 dark:border-green-100",
                            ...
                            props.error ? (
                                ...
                                <TableRow >
                                    <TableCell className="font-medium" colSpan={12}>
                                        ...
                                        >No Booking Available</h3>
                                    </TableCell>
                                </TableRow>
                            ) : currentBookings.map((booking) => (
                                <TableRow key={booking._id}>
                                    <TableCell className="font-medium">B{booking._id.slice(0,6)}</TableCell>
                                    ...
                                    <TableCell className="text-right">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem onClick={() => updateBookingStatus(booking._id, 'Approved')}>
                                                    Approve
                                                </DropdownMenuItem>
