...
const RoomDescription: React.FC<RoomDescriptionProps> = (props) => {
    return (
        <section className={`bg-${props.bgColor} py-4 md:py-8 px-0`}>
            <Container style={`flex flex-col ${props.imagePosition === 'right' ? 'md:flex-row-reverse' : 'md:flex-row'}  gap-x-12 gap-y-4 `}>
                <div data-aos={props.imagePosition === 'right' ? 'fade-left' : 'fade-right'}  className="relative w-full lg:w-[40%]">
                ...
                <div data-aos={props.imagePosition === 'right' ? 'fade-right' : 'fade-left'} className="md:p-6 lg:w-[60%] flex flex-col justify-center gap-y-6">
