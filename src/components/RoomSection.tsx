...
const RoomDescription: React.FC<RoomDescriptionProps> = (props) => {
    return (
        <section className={`bg-${props.bgColor} py-8 md:py-16`}>
            <div className={`h-[calc(100vh-20vh)] w-11/12 mx-auto flex flex-col ${props.imagePosition === 'right' ? 'md:flex-row-reverse' : 'md:flex-row'}  gap-12 `}>
                ...
                <div className="p-6 lg:w-[60%] flex flex-col justify-center gap-y-6">
                    <h2 className="font-[family-name:var(--font-primary)] text-3xl font-bold tracking-tight text-primary md:text-4xl lg:text-5xl">{props.title}</h2>
